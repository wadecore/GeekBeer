...
const unsigned int DRIVE_SPEED 		= 95;	//Forward/Reverse Driving Speed Value, 0-100
...
const int BLIND_DRIVE_TIME = 330; //milliseconds to drive forward at intersection
const int BLIND_TURN_TIME  = 350; //milliseconds to turn without checking sensor (time to move off line)
